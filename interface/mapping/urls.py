...
# local app
from .field_views import NewFieldView, EditFieldsView ,FieldReviewView
from .reviewer_views import NewReviewView, EditReviewView
...
urlpatterns = [
    ...
    path("view/<int:mapping_id>/lists/view/<int:list_id>/field/new", NewFieldView.as_view(), name="field_new"),
    ...
    path("view/<int:mapping_id>/lists/view/<int:list_id>/review/new", NewReviewView.as_view(), name="review_new"),
    path("view/<int:mapping_id>/lists/view/<int:list_id>/review/edit", EditReviewView.as_view(), name="review_edit"),
]