...
import requests
from review.models import PublicationList
    ...
    def post(self, request: Any, *args: Any, **kwargs: Any) -> Any:
        ...
        if len(already_added_publications) > 0:
            ...
            try:
                ...
                return HttpResponseBadRequest("The DOI does not exist", status=417)  # Expectation Failed
        ...
        if request.POST.__contains__("list_id"):
            ...
            if request.user in publication_list.review.reviewers.all():
